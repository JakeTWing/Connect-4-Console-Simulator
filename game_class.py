...
class game:
    ...
    def start_game(self):
        ...
        true_inputs = ["t", "true", "tru", "tr", "yes", "confirm", "yeah", "y"]
    ...
    def turn(self, is_player_x, chosen_column, ):
        ...
        completed_move = self.game_board.place_peice(is_player_x, chosen_column) #trys to place a peice
        win, location, draw = self.game_board.check_for_win(is_player_x) #checks for a win
    ...
    def ai_game(self, num_of_games = 1,  x_hard_mode = True, x_path_len = 4, o_hard_mode = True, o_path_len = 4):
        ...
        if x_path_len > 5:
            x_path_len = 5
            print("path_len cannot be greater than 5")
        if o_path_len > 5:
            o_path_len = 5
            print("path_len cannot be greater than 5")
        #creates ai objects
